...
import Compiler from '../../plugin-jsx/src/compiler';
  ...
  setup() {
    ...
    this.add(movi.moviComponent("div", {
      setup() {
        ...
        this.add(movi.moviComponent("text", {
          setup() {
            this.setText("MOVI JSX Explorer");
          }
        }));
      }
    }));
    this.add(movi.moviComponent("div", {
      setup() {
        this.class.add("split_editor");
        this.add(movi.moviComponent("div", {
          onbuilded: self.sourceEditorSettings,
          setup() {
            this.attr.add({
              "id": "source"
            });
            this.class.add("editor");
          }
        }));
        this.add(movi.moviComponent("div", {
          onbuilded: self.outputEditorSettings,
          setup() {
            this.attr.add({
              "id": "output"
            });
