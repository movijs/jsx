(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@babel/types'), require('@babel/core'), require('@babel/plugin-syntax-jsx'), require('html-tags'), require('svg-tags')) :
  typeof define === 'function' && define.amd ? define(['@babel/types', '@babel/core', '@babel/plugin-syntax-jsx', 'html-tags', 'svg-tags'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.movi = factory(global.t, global.babel, global.babelParser, global.htmlTags, global.svgTags));
})(this, (function (t, babel, babelParser, htmlTags, svgTags) { 'use strict';
